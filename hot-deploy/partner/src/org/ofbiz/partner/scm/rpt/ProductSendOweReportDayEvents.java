...
public class ProductSendOweReportDayEvents {
	...
	public static String getMainDataSql(HttpServletRequest request) throws Exception {
		...
		String sql = " SELECT \r\n"+
				...
				" 	SUM(IFNULL(LAST_WEEK_BAL,0)+IFNULL(THIS_WEEK_BAL,0)-IFNULL(NOTIFICATION_HIS.ORDER_QTY,0)) AS TODAY_BAL, \r\n"+
				" 	SUM(IFNULL(IF(VERIFY_ENTRY.MATERIAL_ID,VERIFY_ENTRY.ORDER_QTY*PM.BOARD_COUNT,NOTIFICATION.VOLUME),0)) AS VOLUME, \r\n"+
				" 	SUM(IFNULL(LAST_WEEK_BAL,0)+IFNULL(THIS_WEEK_BAL,0))*IFNULL(PM.BOARD_COUNT,0) - IF(NOTIFICATION_HIS.VOLUME,SUM(NOTIFICATION_HIS.VOLUME),SUM(IFNULL(NOTIFICATION_HIS.ORDER_QTY,0))*IFNULL(PM.BOARD_COUNT,0)) AS TODAY_TOTAL \r\n"+
				" FROM ( \r\n"+
				" 	SELECT \r\n"+
				...
				"   SELECT \r\n"+
				"     MATERIAL_ID, \r\n"+
				"     SUM(IFNULL(SUN_NOR_IN_QTY,0)+IFNULL(SUN_CHG_BRD_QTY,0)+IFNULL(MON_NOR_IN_QTY,0)+IFNULL(MON_CHG_BRD_QTY,0)+IFNULL(TUE_NOR_IN_QTY,0)+IFNULL(TUE_CHG_BRD_QTY,0)+IFNULL(WEN_NOR_IN_QTY,0)+IFNULL(WEN_CHG_BRD_QTY,0)+IFNULL(THU_NOR_IN_QTY,0)+IFNULL(THU_CHG_BRD_QTY,0)+IFNULL(FRI_NOR_IN_QTY,0)+IFNULL(FRI_CHG_BRD_QTY,0)+IFNULL(STA_NOR_IN_QTY,0)+IFNULL(STA_CHG_BRD_QTY,0)) AS LAST_WEEK_BAL \r\n"+
				...
				" LEFT JOIN ( \r\n"+
				"  select \r\n"+
				" 	  IFNULL(VERIFY_ENTRY1.MATERIAL_ID,NOTIFICATION1.MATERIALID) AS MATERIAL_ID, \r\n"+
				" 	  SUM(IFNULL(VERIFY_ENTRY1.ORDER_QTY,0)) AS ORDER_QTY, \r\n"+
				"    SUM(IFNULL(if(VERIFY_ENTRY1.MATERIAL_ID,0,NOTIFICATION1.VOLUME),0)) AS VOLUME \r\n"+
				"  FROM ( \r\n"+
				"	 	SELECT \r\n"+
				"	 		T1.DELIVER_NUMBER DELIVERNUMBER, \r\n"+
				"	 		T2.MATERIAL_ID MATERIALID, \r\n"+
				...
				"	 	GROUP BY T1.DELIVER_NUMBER,T2.MATERIAL_ID HAVING DELIVERNUMBER IS NOT NULL \r\n"+
				"   ) NOTIFICATION1 \r\n"+
				"   LEFT JOIN PRODUCT_OUT_VERIFY_HEAD VERIFY1 ON (NOTIFICATION1.DELIVERNUMBER=VERIFY1.DELIVER_NUMBER AND NOTIFICATION1.MATERIALID=VERIFY1.MATERIAL_ID) \r\n"+
				"   LEFT JOIN PRODUCT_OUT_VERIFY_ENTRY VERIFY_ENTRY1 ON (VERIFY1.DELIVER_NUMBER=VERIFY_ENTRY1.DELIVER_NUMBER AND VERIFY1.MATERIAL_ID=VERIFY_ENTRY1.PARENT_MATERIAL_ID) \r\n"+
				"   GROUP BY IFNULL(VERIFY_ENTRY1.MATERIAL_ID,NOTIFICATION1.MATERIALID) \r\n"+
				" ) NOTIFICATION_HIS ON IFNULL(VERIFY_ENTRY.MATERIAL_ID,NOTIFICATION.MATERIALID) = NOTIFICATION_HIS.MATERIAL_ID \r\n"+
