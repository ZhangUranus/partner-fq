Ext.define('SCM.controller.WorkshopReturnMaterial.WorkshopReturnMaterialController', {
			...
			init : function() {
				this.control({
							...
							// 列表审核按钮
							'WorkshopReturnMateriallist button[action=audit]' : {
								click : this.auditBill
							},
							// 列表反审核按钮
							'WorkshopReturnMateriallist button[action=unaudit]' : {
			...
			afterInitComponent : function() {
				...
				this.workshopFields.addListener('change', this.changeWorkshop, this);
			},
			...
			changeWorkshop: function(field, newValue, oldValue){
				var me = this;
