Ext.define('SCM.view.WorkshopStockAdjust.EditUI', {
			...
			alias : 'widget.workshopstockadjustedit',
			height : 550,
			width : 815,
			title : '车间调整单',
			layout : 'fit',
				...
				Ext.applyIf(me, {
							items : [{
										...
										items : [{
													...
													xtype : 'gridpanel',
													id : 'WorkshopStockAdjust-edit-grid',
													region : 'center',
													...
													columns : [{
																...
																text : '车间',
																gridId : 'WorkshopStockAdjust-edit-grid',
																editor : {
																	xtype : 'combogrid',
																	valueField : 'id',
																	displayField : 'name',
																...
																dataIndex : 'billType',
																text : '单据类型',
																gridId : 'WorkshopStockAdjust-edit-grid-billtype',
																editor : {
																	xtype : 'combogrid',
																	valueField : 'id',
																	displayField : 'name',
