Ext.define('SCM.view.ConsignReturnMaterial.EditUI', {
			...
			alias : 'widget.ConsignReturnMaterialedit',
			height : 550,
			width : 815,
			title : '委外退料单',
			layout : 'fit',
			...
			initComponent : function() {
				...
				Ext.applyIf(me, {
							items : [{
										xtype : 'form',
										name : 'ConsignReturnMaterialform',
										bodyPadding : 5,
										border : 0,
										layout : 'border',
										items : [{
													...
													xtype : 'gridpanel',
													id : 'ConsignReturnMaterial-edit-grid',
													region : 'center',
													store : Ext.create('ConsignReturnMaterialEditEntryStore'),
													columns : [{
																xtype : 'gridcolumn',
																dataIndex : 'id',
																text : 'id',
																...
																text : '仓库',
																gridId : 'ConsignReturnMaterial-edit-grid',
																editor : {
																	xtype : 'combogrid',
																	valueField : 'id',
																	displayField : 'name',
