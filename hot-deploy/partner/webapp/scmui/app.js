...
Ext.application({
			...
			'Main', 'homepage.HomePageController', 'basedata.UnitController', 'basedata.WarehouseTypeController', 'basedata.WarehouseController', 'basedata.CustomerController', 'basedata.DepartmentController',
					...
					'ProductInwarehouse.ProductInwarehouseController','ProductOutwarehouse.ProductOutwarehouseController', 'basedata.RegionController', 'ProductMap.ProductMapController', 'ProductOutNotification.ProductOutNotificationController', 'ProductManualOutwarehouse.ProductManualOutwarehouseController','ProductOutVerify.ProductOutVerifyController', 'ProductReturn.ProductReturnController',
					...
					'rpt.MaterialDetailQryController','rpt.ProductSendOweReportDayController','rpt.CurrentStockQryController','rpt.ProductOutReportController','ProductOutNotificationModify.ProductOutNotificationModifyController'],
