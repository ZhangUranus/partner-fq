...
SELECT * FROM ofbiz.product_out_notification_entry where parent_id = (SELECT id FROM ofbiz.product_out_notification where GOOD_NUMBER ='ECIS41180') and MATERIAL_ID='4e61776b-3330-4ae2-a54d-491b6c210e89';
