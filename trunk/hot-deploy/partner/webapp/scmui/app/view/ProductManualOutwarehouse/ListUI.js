 ...
 * Mark
 */
Ext.define('SCM.view.ProductManualOutwarehouse.ListUI', {
			extend : 'Ext.container.Container',
			requires : ['SCM.extend.toolbar.BillBaseToolbar', 'SCM.extend.toolbar.BillSearchToolbar'],
			alias : 'widget.ProductManualOutwarehouselist',
			title : '成品手工出仓单查询',
			layout : {
				type : 'border'
			},
			initComponent : function() {
				var me = this;
				var entryStore = Ext.create('ProductManualOutwarehouseEditEntryStore', {
							id : 'ProductManualOutwarehouseListEntry'
						});
				Ext.applyIf(me, {
							items : [{
										...
										title : '',
										region : 'center',
										store : 'ProductManualOutwarehouse.ProductManualOutwarehouseEditStore',
										columns : [{
													header : '序号',
													xtype : 'rownumberer',
													width : 40
													...
													xtype : 'gridcolumn',
													dataIndex : 'customerCustomerName',
													width : 150,
													groupable : false,
													text : '客户'
												}, {
