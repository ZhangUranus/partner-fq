Ext.define('SCM.view.WorkshopReturnProduct.EditUI', {
			...
			alias : 'widget.WorkshopReturnProductedit',
			height : 550,
			width : 815,
			title : '制造退货单',
			layout : 'fit',
			...
			initComponent : function() {
				...
				Ext.applyIf(me, {
							items : [{
										xtype : 'form',
										name : 'WorkshopReturnProductform',
										bodyPadding : 5,
										border : 0,
										layout : 'border',
										items : [{
													...
													columns : [{
																...
																editor : {
																	...
																	store : Ext.create('MaterialBomWarehouseComboStore'),
																	matchFieldWidth : false,
																	listeners : {
																		scope : this,
