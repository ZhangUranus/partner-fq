Ext.define('SCM.view.WorkshopWarehousing.CheckListUI', {
			extend : 'Ext.window.Window',
			requires : ['SCM.ux.combobox.ComboGrid'],
			alias : 'widget.WorkshopWarehousingchecklist',
			...
			initComponent : function() {
				var me = this;
				var entryStore = Ext.create('WorkshopWarehousingCheckStore');
				Ext.applyIf(me, {
							items : [{
										xtype : 'gridpanel',
										id : 'WorkshopWarehousing-check-list-grid',
										region : 'center',
										border : 0,
										store : entryStore,
										columns : [{
													...
													text : '车间',
													gridId : 'WorkshopWarehousing-check-list-grid',
													editor : {
														xtype : 'combogrid',
														valueField : 'id',
														displayField : 'name',
