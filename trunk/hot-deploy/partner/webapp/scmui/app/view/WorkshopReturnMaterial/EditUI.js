Ext.define('SCM.view.WorkshopReturnMaterial.EditUI', {
			...
			alias : 'widget.WorkshopReturnMaterialedit',
			height : 550,
			width : 815,
			title : '制造退料单',
			layout : 'fit',
			...
			initComponent : function() {
				...
				Ext.applyIf(me, {
							items : [{
										xtype : 'form',
										name : 'WorkshopReturnMaterialform',
										bodyPadding : 5,
										border : 0,
										layout : 'border',
										items : [{
													...
													xtype : 'gridpanel',
													id : 'WorkshopReturnMaterial-edit-grid',
													region : 'center',
													store : Ext.create('WorkshopReturnMaterialEditEntryStore'),
													columns : [{
																xtype : 'gridcolumn',
																dataIndex : 'id',
																text : 'id',
																...
																text : '仓库',
																gridId : 'WorkshopReturnMaterial-edit-grid',
																editor : {
																	xtype : 'combogrid',
																	valueField : 'id',
																	displayField : 'name',
