Ext.define('SCM.controller.rpt.MaterialDetailQryController', {
			extend : 'Ext.app.Controller',
			mixins : ['SCM.extend.exporter.Exporter'],
			views : ['rpt.bcq.MaterialDetailUI'],
			stores : ['rpt.MaterialDetailQryStore'],
			models : ['rpt.MaterialDetailQryModel'],
			...
			init : function() {
				this.control({
							...
							// 列表界面刷新
							'MaterialDetailUI button[action=search]' : {
								click : this.refreshRecord
							},
							// 数据导出
							'MaterialDetailUI button[action=export]' : {
