...
public static void main(String[] args){
	...
	Field testfield2=new Field("purchser", "采购员","entity","TSystemUser"); 
	Field testfield3=new Field("auditer", "审核员","entity","TSystemUser");
	Field testfield4=new Field("totolAccount", "总金额","float");
	...
	Field testentryfield2=new Field("amount", "数量","float");
	...
	Field testentryfield6=new Field("account", "金额","float");
