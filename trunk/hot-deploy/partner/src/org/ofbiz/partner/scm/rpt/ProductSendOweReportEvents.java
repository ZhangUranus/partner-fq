...
//		}
		...
		String sql = "SELECT\r\n"+
				...
				"	SUM(STOCKING) AS STOCKING,\r\n"+
				"	SUM(LAST_WEEK_IN_QTY)+SUM(LAST_WEEK_CHG_QTY)-SUM(LAST_WEEK_PLN_QTY)+SUM(THIS_WEEK_IN_QTY)+SUM(THIS_WEEK_CHG_QTY)-SUM(THIS_WEEK_PLN_QTY)-SUM(STOCKING) AS STOCKINGBAL,\r\n"+
