...
public class ProductSendOweReportEvents {
	...
	public static String getMainDataSql(HttpServletRequest request) throws Exception {
		...
		String sql = "SELECT\r\n"+
				...
				"	SUM(LAST_WEEK_IN_QTY*BOARD_COUNT)+SUM(LAST_WEEK_CHG_QTY*BOARD_COUNT)-SUM(LAST_WEEK_PLN_QTY*BOARD_COUNT)+SUM(THIS_WEEK_IN_QTY*BOARD_COUNT)+SUM(THIS_WEEK_CHG_QTY*BOARD_COUNT)-SUM(THIS_WEEK_PLN_QTY*BOARD_COUNT)-AVG(STOCKING)*BOARD_COUNT AS STOCKINGBAL \r\n"+
				"FROM (    \r\n"+
