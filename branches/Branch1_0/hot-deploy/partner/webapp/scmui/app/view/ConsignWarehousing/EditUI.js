Ext.define('SCM.view.ConsignWarehousing.EditUI', {
			...
			alias : 'widget.ConsignWarehousingedit',
			height : 550,
			width : 815,
			title : '委外入库单',
			layout : 'fit',
			...
			initComponent : function() {
				...
				var entryStore = Ext.create('ConsignWarehousingEditEntryStore');
				...
				Ext.applyIf(me, {
							items : [{
										...
										items : [{
													...
													xtype : 'gridpanel',
													id : 'ConsignWarehousing-edit-grid',
													region : 'center',
													store : entryStore,
													columns : [{
																xtype : 'gridcolumn',
													...
													items : [{
																...
																xtype : 'label',
																text : '注意：加工件耗料单价、金额、单据总金额在单据提交后才能显示！',
																margin : 5,
																colspan : 3,
																style : {
																	'font-weight': 'bold',
