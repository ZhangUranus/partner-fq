...
Ext.define('SCM.view.ProductReturn.ListUI', {
			...
			initComponent : function() {
				var me = this;
				var entryStore = Ext.create('ProductReturnEditEntryStore', {
							id : 'ProductReturnListEntry'
						});
				...
				Ext.applyIf(me, {
							items : [{
										...
										title : '',
										region : 'center',
										store : 'ProductReturn.ProductReturnEditStore',
										columns : [{
													header : '序号',
													xtype : 'rownumberer',
													width : 40
