 ...
 * 
 * 类型2：其它 条码1：40099792201202270627 
 * 40099792 - 宜家产品代号 
 * 20120227 - 日期 
 * 06 - 第 6 周 
...
public class BarCode {
	 ...
	 * 初始化条形码
	 */
	public BarCode(String code, String serie) throws Exception {
		this.code = code;
		this.serie = serie;
		if (this.code.indexOf("240") != 0) {
			this.type = 2;
		}
		if (this.type == 1) {
			if (!(this.code.length() > 24)) {
				throw new Exception("产品条码格式错误，请检查后重新输入！");
			}
		} else {
