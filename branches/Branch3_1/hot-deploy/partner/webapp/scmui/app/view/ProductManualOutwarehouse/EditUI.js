Ext.define('SCM.view.ProductManualOutwarehouse.EditUI', {
			...
			alias : 'widget.ProductManualOutwarehouseedit',
			height : 550,
			width : 815,
			title : '成品手工出仓单',
			layout : 'fit',
			...
			initComponent : function() {
				...
				Ext.applyIf(me, {
							items : [{
										xtype : 'form',
										name : 'ProductManualOutwarehouseform',
										bodyPadding : 5,
										border : 0,
										layout : 'border',
										items : [{
													...
													xtype : 'gridpanel',
													id : 'ProductManualOutwarehouse-edit-grid',
													region : 'center',
													store : Ext.create('ProductManualOutwarehouseEditEntryStore'),
													columns : [{
																xtype : 'numbercolumn',
																dataIndex : 'sort',
																editor : {
																...
																text : '仓库',
																gridId : 'ProductManualOutwarehouse-edit-grid',
																editor : {
																	xtype : 'combogrid',
																	valueField : 'id',
																	displayField : 'name',
