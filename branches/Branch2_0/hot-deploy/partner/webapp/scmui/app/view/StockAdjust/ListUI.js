...
Ext.define('SCM.view.StockAdjust.ListUI', {
			...
			initComponent : function() {
				var me = this;
				var entryStore = Ext.create('StockAdjustEditEntryStore', {
							id : 'StockAdjustListEntry'
						});
				Ext.applyIf(me, {
							items : [{
										...
										title : '',
										region : 'center',
										store : 'StockAdjust.StockAdjustEditStore',
										columns : [{
													header : '序号',
													xtype : 'rownumberer',
													width : 40
